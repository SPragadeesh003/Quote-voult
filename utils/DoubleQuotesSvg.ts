...
<svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="rgba(255,255,255,0.1))" stroke="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
